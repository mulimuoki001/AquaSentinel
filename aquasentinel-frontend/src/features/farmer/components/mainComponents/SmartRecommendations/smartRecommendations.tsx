    ...
    return (
        <div className="layout">
            ...
            <div className="page-title">
                        <Link to="/dashboard/farmer/irrigation-history"><img src="../../public/fast-backward.png" className="back-icon" alt="back" /></Link>
                        <h1>Smart Recommendations</h1>
                        <Link to="/dashboard/farmer/export-logs"><img src="../../public/fast-forward.png" alt="forward" /></Link>
                    </div>
